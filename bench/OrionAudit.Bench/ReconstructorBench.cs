...
/// <summary>
/// Reconstruction cost grows with the number of audit rows replayed. This bench seeds N updates
/// and times <see cref="IAuditReconstructor.ReconstructAsync"/>.
/// </summary>
[MemoryDiagnoser]
[SimpleJob(warmupCount: 3, iterationCount: 5)]
public class ReconstructorBench
{
    [Auditable]
    ...
    public async Task Setup()
    {
        ...
        services.AddOrionAudit<BenchDb>(o => o.Audit<Row>());
    ...
    [Benchmark]
    public async Task<Row?> Reconstruct_AtLatest()
    {
        await using var scope = sp.CreateAsyncScope();
